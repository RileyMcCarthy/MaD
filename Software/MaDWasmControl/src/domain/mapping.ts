...
export function configToShared(
  ...
  return {
    ...
    'Load Cell Sensitivity (nV/V)': config.loadCellSensitivity,
    'Load Cell Zero Balance (nV/V)': config.loadCellZeroBalance,
...
export function configFromShared(
  ...
  return {
    ...
    loadCellSensitivity: config['Load Cell Sensitivity (nV/V)'],
    loadCellZeroBalance: config['Load Cell Zero Balance (nV/V)'],
