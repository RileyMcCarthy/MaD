...
describe('codec golden byte vectors (frozen — guards the wire format)', () => {
  ...
  it('MachineConfiguration', () => {
    expect(
      bytes(nu.encodeMachineConfiguration({ name: 'Tester-1', encoderStepsPerMM: 200, servoStepsPerMM: 400, loadCellCapacity: 100, loadCellSensitivity: 1000000, loadCellZeroBalance: 5, maxPosition: 250, maxVelocity: 50, maxAcceleration: 100, maxForceTensile: 1234.567, homingVelocity: 5, homingOffset: 2, jawOffset: 3 })),
    ).toEqual(GOLD.config);
  });
  it('SampleProfile', () => {
    expect(
...
describe('round-trip within scale precision', () => {
  ...
  it('MachineConfiguration name + maxForceTensile scale', () => {
    const v = { name: 'Tester-1', encoderStepsPerMM: 200, servoStepsPerMM: 400, loadCellCapacity: 100, loadCellSensitivity: 1000000, loadCellZeroBalance: 5, maxPosition: 250, maxVelocity: 50, maxAcceleration: 100, maxForceTensile: 1234.567, homingVelocity: 5, homingOffset: 2, jawOffset: 3 };
